...
|**StratoStruct** |A web page to find local suppliers of prefabricated construction products ranked by proximity | MongoDB, Express, React, Node, HTML, CSS, Mapbox API | [StratoStruct Repo](https://github.com/HOOLAHAN/stratostruct_client) + [StratoStruct Website](http://stratostruct.s3-website.eu-west-2.amazonaws.com/)
